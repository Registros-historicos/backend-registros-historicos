...
def update_institucion_id_coordinador(id_institucion: int, id_coordinador: Optional[int], user) -> Optional[Institucion]:
    """
    ...
    return repo.actualizar_id_coordinador(id_institucion, id_coordinador)